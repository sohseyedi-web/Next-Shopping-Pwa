  ...
  return (
    <>
      ...
      <section className="h-screen place-items-center grid">
        <form className="border border-slate-400 border-solid  w-[90%] lg:w-[30%] md:w-[75%] mx-auto rounded py-2 px-3 shadow">
          <h3 className="text-center lg:text-3xl md:text-2xl text-2xl text-blue-600 font-semibold tracking-[4px] mb-5">
            Nike Shop 
          </h3>
          <p className="text-[#252525] mt-3 mb-1 opacity-90">Welcome here!</p>
